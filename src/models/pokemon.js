...
module.exports = (sequelize, DataTypes) => {
    return sequelize.define('Pokemon', {
      ...
      hp: {
        ...
        allowNull: false,
        validate: {
          isInt: { msg: 'Veuillez uniquement utiliser des nombres entiers pour les points de vie.'},
          min: {
            args: [0],
      ...
      cp: {
        ...
        allowNull: false,
        validate: {
          isInt: { msg: 'Veuillez uniquement utiliser des nombres entiers pour les points de dégâts.'},
          min: {
            args: [0],
      ...
      picture: {
        ...
        allowNull: false,
        validate: {
          isUrl: { msg: 'Veuillez utiliser une URL valide l\'image.'},
